...
class DigitalBase
{
  protected:
	...
	//! @param t_pin Pin name, see @ref PINs_grp
	//! @param t_pin_config Pin configuration, see @ref PinConf
	DigitalBase( pin_name_t t_pin, uint32_t t_pin_config );
...
class DigitalIn : public DigitalBase
{
  public:
	...
	//! @param t_pin Any MCU pin name, see @ref PINs_grp
	DigitalIn( pin_name_t t_pin );

	//! @brief Constructor for digital input pin. It is for experienced users.
	//! @param t_pin Any MCU pin name, see @ref PINs_grp
	//! @param t_pin_config Pin configuration, see @ref PinConf
	DigitalIn( pin_name_t t_pin, uint32_t t_pin_config );
...
class DigitalOut : public DigitalBase
{
  public:
	...
	DigitalOut( pin_name_t t_pin, uint32_t t_pin_output = 0 );

	//! @brief Constructor for digital output pin. It is for experienced users.
	//! @param t_pin Any MCU pin name, see @ref PINs_grp.
	//! @param t_pin_output Initial logic level on output.
	//! @param t_pin_config Pin configuration, see @ref PinConf
	DigitalOut( pin_name_t t_pin, uint32_t t_pin_output, uint32_t t_pin_config );
